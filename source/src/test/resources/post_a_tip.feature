Feature: post a tip
   ...
   Scenario: update a tip
        Given I am on the page "tips/Tip 1/edit"
        Then I should not be able to modify the title "Tip 1"
        When I input the content "This is a modified tip 1"
        When I click the submit button
        Then I should see the content "This is a modified tip 1"
        And the URL should be "tips/Tip%201"
        
        Given I am on the page "tips/Tip 2/edit"
        Then I should see the Not Found page
   ...
   Scenario: input a tip
        ...
        And the URL should be "tips/Tip%202"
